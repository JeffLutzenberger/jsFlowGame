...
Rectangle.prototype = {
    ...
    updatePoints : function () {
        var xl1 = -this.w * 0.5,
            ...
            pl5 = this.rotatePoint(xl1, 0, this.theta),
            pl6 = this.rotatePoint(xl2, 0, this.theta);
        ...
        this.p5 = new Vector(this.x + pl5.x, this.y + pl5.y);
        this.p6 = new Vector(this.x + pl6.x, this.y + pl6.y);
