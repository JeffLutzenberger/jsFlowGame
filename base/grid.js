...
GridWall.prototype = {
    ...
    hit : function (p) {
        var n, r = 10;
        if (this.hasDoor && this.doorIsOpen && this.doorColor === p.color) {
    ...
    draw : function (canvas, color) {
        ...
        if (this.hasDoor) {
            ...
            //colored door
            canvas.line(this.p5, this.p7, 30, doorColor, 0.25);
            canvas.line(this.p5, this.p7, 15, doorColor, 0.75);
            canvas.line(this.p5, this.p7, 10, doorColor, 1.0);
            canvas.line(this.p5, this.p7, 5, [255, 255, 255], 0.8);

            canvas.line(this.p6, this.p8, 30, doorColor, 0.25);
            canvas.line(this.p6, this.p8, 15, doorColor, 0.75);
